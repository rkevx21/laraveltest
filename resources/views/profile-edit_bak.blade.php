        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="container col-lg-offset-4 col-lg-4">
                          <div class="row"> 
                            <form action="{{ route('upload') }}" enctype="multipart/form-data" method="POST">
                              ...
                              <img src="/storage/{{auth()->user()->avatar}}" all="Image">
                    ...
                    <form method="POST" action="{{ route('profile.update', [$profileEdit->id]) }}">
                        {{ csrf_field() }}
...
{{-- 
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               {!! Form::text('name',$profileEdit->name,['class'=>'form-control']),$errors->has('name') ? ' is-invalid' : ''     !!}      --}}    
...
{{--                                 @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail q Address') }}
                            </label>
